...
This is a `cli` option that controls the number of ANSI colors. Set `options(cli.num_colors = 0)` to turn off ANSI colors. See `cli::num_ansi_colors()`. See also the `cli.default_num_colors` option.
